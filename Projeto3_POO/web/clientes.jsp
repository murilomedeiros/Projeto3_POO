...
<html>
  ...
  <body ng-app="countCliente" ng-controller="counterCliente">
    ...
    <div id="clientes" class="container-fluid page" >
      ...
      <!-- Scroll Bottom -->
      <a id="scrollbottom" href="#table-cliente" class="scroll"><i class="fa fa-arrow-down"></i></a>
      <!-- Scroll Bottom End -->

      <%
         String btnE = "hidden";//DECLARANDO AS VARIÁVEIS AUXILIAR PARA A BUSCA DO CEP ---Início---
         String btnA = "";
         String auxStreet = "";
         String auxCep = "";
         String auxCity = "";
         ...
         String auxCPF = "";
         String auxEmail = "";
         String auxPhone = "";//DECLARANDO AS VARIÁVEIS AUXILIAR PARA A BUSCA DO CEP  ---Fim---
         int auxI = BancoClientes.getClientes().size(); //DECLARANDO ESSA VARIAVEL PARA USAR NO EDITAR
         try {
            String msg1 = "";//DECLARANDO AS VARIÁVEIS PARA AS MENSAGENS ---Início---
            String msg2 = "";
            String msg3 = "";//DECLARANDO AS VARIÁVEIS PARA AS MENSAGENS ---Fim---
            String name = request.getParameter("name"); //PEGANDO OS PARÂMETROS ---Início---
            ...
            String cep = request.getParameter("cep");  //PEGANDO OS PARÂMETROS ---Fim---
            if ((name != null && cpf != null && rg != null && email != null && phone != null && street != null && number != null && cep != null && city != null && district != null && state != null) || (name != "" && cpf != "" && rg != "" && email != "" && phone != "" && street != "" && number != "" && cep != "" && city != "" && district != "" && state != "")) {
               //CHECKANDO OS PARÂMETROS, PARA DEPOIS VER QUAL SERÁ A AÇÃO (INCLUIR, ALTERAR OU EXCLUIR)
               if ((request.getParameter("include") != null) && (name != "" && cpf != "" && rg != "" && email != "" && phone != "" && street != "" && number != "" && cep != "" && city != "" && district != "" && state != "")) { //CHECKANDO A AÇÃO INCLUDE
                  btnE = "hidden";
                  btnA = "";
                  for (int x = 0; x < BancoClientes.getClientes().size(); x++) { //CHECKANDO SE JÁ EXISTE ESSE CLIENTE ---Início---
                  ...
                  }//CHECKANDO SE JÁ EXISTE ESSE CLIENTE ---Fim---
      ...
      <div class="row justify-content-center">
        <div class="col-md-5">
          <form action="clientes.jsp">
            ...
            <input class="form-input" placeholder="Email" type="email" name="email" value="<%=auxEmail%>" data-toggle="tooltip" data-placement="left" title="Digite seu Email" maxlength="50"/>
